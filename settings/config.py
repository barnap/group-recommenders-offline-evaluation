...
group_sizes_to_test = [4, 8] # [2, 3, 4, 5, 6, 7, 8]
...
evaluation_strategy = "DECOUPLED"  # COUPLED / DECOUPLED evaluation type (see https://dl.acm.org/doi/10.1145/3511047.3537650)

inverse_propensity_debiasing = True #For COUPLED only: True / False whether to normalize feedback with self-normalized inverse propensity score (see https://dl.acm.org/doi/10.1145/3511047.3537650)
